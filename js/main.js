    ...
    $('.big-btn[href^="#"]').on("click", function (e) {
      ...
      $("html, body")
        ...
        .animate(
          {
            scrollTop:
              $(target).offset().top - $(".page_header").outerHeight() + 40,
          },
          900,
          "easeInOutQuart",
          function () {
  ...
  function windowLoadInit() {
    ...
    if ($().flexslider) {
      ...
      $introSlider.each(function (index) {
        ...
        var speed =
          typeof data.speed !== "undefined" ? parseInt(data.speed, 10) : 7000;
    ...
    if ($().owlCarousel) {
      $(".owl-carousel").each(function () {
        ...
        var loop = data.loop ? data.loop : false,
          ...
          autoplayHoverPause = data.autoplayHoverPause
            ? data.autoplayHoverPause
            : false,
    ...
    // Aded by Moses
    var offices = [
      { latLng: [25.276987, 55.296249], name: "Dubai" },
      { latLng: [24.453884, 54.377343], name: "Abu Dhabi" },
    ];
    ...
    $("#map-vector").vectorMap({
      ...
      focusOn: {
        region: "AE",
        scale: window.innerWidth < 768 ? 3.5 : 6,
        animate: true,
      },
    });
